...
```{r color-pal, fig.cap = "调色板",fig.subcap=c("渐变","Hue-Saturation-Value (HSV) color model"),out.width="35%",fig.show='hold',fig.asp=1}
n <- 16
...
```{r Alegreya-Sans,fig.show='hold',fig.cap="两种字体",fig.subcap=c("Alegreya Sans 字体","Sans 字体"),out.width="35%",fig.asp=1}
